      ...
      >
        ...
        <div className="fixed z-10 inset-0 overflow-y-auto ">
          <div className="flex items-end sm:items-center justify-center min-h-full p-4 text-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full sm:p-6 w-full">
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    >
                      {isUpdateDescription ? "Update Task" : "Add New Task"}
                    </Dialog.Title>
                    <div className="mt-2 sm:w-[250%]">
                      <form className="">
                        <div>
                          <label
                            htmlFor="task"
